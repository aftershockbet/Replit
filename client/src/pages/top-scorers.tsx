...
export default function TopScorers() {
  const [, params] = useRoute("/top-scorers/:leagueId");
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Top Scorers</p>
            </div>
          </div>
        </div>
          ...
          <CardContent>
            <div className="text-center py-12">
              <p className="text-lg text-muted-foreground mb-4">
                Top scorers data will be integrated here
              </p>
              <p className="text-sm text-muted-foreground">
                This page will display the league's leading goalscorers with their stats and teams
              </p>
            </div>
          </CardContent>
        </Card>
